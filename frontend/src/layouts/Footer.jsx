...
/* ── Footer-only styles, ft- prefixed, reduced-motion safe ── */
const CSS = `
  @keyframes ft-bar {
...
/* Same "live signal" mark as the home page — ties the footer into the app's language. */
function SignalBars() {
  return (
...
/* Section header with a small accent underline — color varies per column. */
  ...
  return (
    <footer className="relative mt-auto overflow-hidden border-t border-base-300/60 bg-base-200/50">
      ...
      <div className="relative mx-auto max-w-5xl px-4 pb-2 pt-12 sm:px-6">
        ...
        {/* ── Columns: brand + the three original sections ── */}
        ...
        {/* ── Bottom row: copyright + trust pill ── */}
